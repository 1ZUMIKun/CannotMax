...
def composite_random_frame():
    # 读取战场背景图
    battlefield = cv2.imread("images/battlefield/battlefield_empty.jpg")
    ...
    for i in range(10):
        x, y = frame_list[i]
        frame = get_random_png_frame("images/battlefield/Arc_Frontliner_Leader")
        ...
        # 裁切到外接矩形
        small_frame = crop_to_bounding_box(small_frame)
    ...
    # 保存结果
    cv2.imwrite("battlefield_composite.png", battlefield)
